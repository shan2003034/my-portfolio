...
const Hero = () => {
  return (
    ...
    <section className="relative w-full min-h-screen bg-black text-white flex items-center overflow-hidden selection:bg-[#deff9a] selection:text-black">
      ...
      <div className="max-w-7xl mx-auto w-full px-8 md:px-16 grid grid-cols-1 lg:grid-cols-12 items-center relative z-10">
        ...
        <motion.div 
          ...
          className="lg:col-span-6 space-y-8 pt-20 lg:pt-0 relative z-20"
        >
          ...
          <div className="pt-10 flex flex-wrap gap-5 items-center">
            ...
            <button className="text-white px-8 py-4 rounded-full font-bold hover:text-[#deff9a] transition-colors duration-300 flex items-center gap-2 group text-lg">
              View My Work 
        ...
        <div className="hidden lg:block absolute right-0 top-0 w-1/2 h-full z-0 pointer-events-none">
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
